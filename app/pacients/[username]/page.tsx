	...
	return (
		<div className='w-full flex flex-col flex-1'>
			...
			<div className='flex items-center justify-around'>
				...
				<Link href={`/consult/${params.username}`} className="h-12 w-44 rounded-xl text-secundary-normal bg-primary-pressed shadow-xl flex items-center justify-center">CONSULTA</Link>
			</div>
